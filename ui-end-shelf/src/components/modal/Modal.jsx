                  ...
                  <section aria-labelledby="options-heading" className="mt-10">
                    ...
                    <form>
                      ...
                      <button
                        ...
                        className="mt-6 flex w-full items-center justify-center rounded-md border border-transparent bg-custom-orange px-8 py-3 text-base font-medium text-white hover:custom-orange focus:outline-none focus:ring-2 focus:ring-custom-orange focus:ring-offset-2"
                      >
                        Request to Rent
                      </button>
                    </form>
