    ...
    <div className="bg-white">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white border table-wrapper border-2 border-green">
            <thead>
              <tr>
              ...
              {vendors.length > 0 ? (
                vendors.map((vendor) => (
                  <tr key={vendor.vendor_id}>
                    ...
                    <td className="py-2 px-4 border-b">
                      {vendor.vendor_shop_license_number}
                    </td>
                    <td className="py-2 px-4 border-b">
                      {vendor.vendor_shop_email}
                    </td>
                    <td className="py-2 px-4 border-b">
                      {vendor.vendor_shop_phone_number}
                    </td>
                    <td className="py-2 px-4 border-b">
                      {vendor.vendor_shop_address}
                    </td>
                    <td className="py-2 px-4 border-b">
                      {vendor.vendor_shop_city}
                    </td>
                    <td className="py-2 px-4 border-b">
                      {vendor.vendor_shop_country}
                    </td>
                    <td className="py-2 px-4 border-b">
                      {vendor.vendor_shop_zipcode}
                    </td>
                    <td className="py-2 px-4 border-b">
